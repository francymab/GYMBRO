-- PROCEDURA PER L'ASSEGNAZIONE SETTIMANALE DI UN DIPENDENTE --
...
BEGIN
    -- Controlliamo che il dipendente non sia licenziato --
    SELECT data_di_licenziamento INTO data_lic FROM dipendente WHERE fk_persona = numero_dipendente;
